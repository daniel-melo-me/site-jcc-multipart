...
O teste confere se as seções principais existem, se os assets referenciados estão disponíveis, se o hero mantém uma área de mídia dedicada, se o mapa/ícones/crédito estão presentes e se o CTA principal do WhatsApp permanece configurado.
